...
import (
	...
	"github.com/Ncog-Earth-Chain/go-ncogearthchain/eventcheck/parentlesscheck"
...
// newHandler returns a new NCOGEarthChain sub protocol manager. The NCOGEarthChain sub protocol manages peers capable
// with the NCOGEarthChain network.
func newHandler(
	c handlerConfig,
) (
	*ProtocolManager,
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping NCOGEarthChain protocol")
	...
	log.Info("NCOGEarthChain protocol stopped")
}
