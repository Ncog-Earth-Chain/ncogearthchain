...
type TestBackend struct {
	...
	pendingRules      ncogearthchain.Rules
}
...
func (t TestBackend) GetRules() ncogearthchain.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() ncogearthchain.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             ncogearthchain.FakeNetRules(),
		pendingRules:      ncogearthchain.FakeNetRules(),
	}
