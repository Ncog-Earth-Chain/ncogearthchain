...
import (
	...
	base "github.com/Ncog-Earth-Chain/forest-base/eventcheck/epochcheck"
...
type Reader interface {
	base.Reader
	GetEpochRules() (ncogearthchain.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules ncogearthchain.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules ncogearthchain.Rules) error {
...
func CheckTxs(txs types.Transactions, rules ncogearthchain.Rules) error {
	maxType := uint8(0)
