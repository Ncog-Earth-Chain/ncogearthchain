...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "ncogearthchain-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "ncogearthchain-test" in exec().
	reexec.Register("ncogearthchain-test", func() {
...
func exec(t *testing.T, args ...string) *testcli {
	...
	// Boot "ncogearthchain". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("ncogearthchain-test", args...)
